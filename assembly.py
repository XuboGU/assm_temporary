...
def assembly(pitch=100, z=0.5, xyboundary_type='vacuum', zboundary_type='reflective',fuel_pin_universe=''):
    ...
    template_x = np.array([5, 8, 3])
    template_y = np.array([2, 2, 2])
    ...
    model.settings.batches = 10 # total number of batches to execute
    model.settings.inactive = 3 # inactive batches used in a k-eigenvalue calculation
    model.settings.particles = 100 # number of neutrons to simulate
